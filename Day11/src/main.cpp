...
void part_2()
{
         ...
         ++round)
    {
        ...
        for (u64 monkey_idx = 0;
             monkey_idx < monkeys.size();
             ++monkey_idx)
        {
            if (round == 11 and
                monkey_idx == 2)
            ...
            auto& monkey = monkeys[monkey_idx];
            ...
            while (monkey.items.size() > 0)
            {
                ...
                worry_level = worry_level % big_modulo;
